    ...
    <footer className="bg-[var(--color-bg-dark)] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Oficina */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-white/80 uppercase tracking-wider">Oficina</h3>
            <div className="space-y-2 text-sm text-white/60">
              ...
              {siteConfig.contacts.map(c => (
                <a key={c.email} href={`mailto:${c.email}`} className="block hover:text-white transition-colors">
                  {c.email}
                </a>
              ))}
            </div>
          ...
          {/* Menu */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-white/80 uppercase tracking-wider">Menú</h3>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          {siteConfig.social.whatsapp && (
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#25D366]/20 hover:bg-[#25D366]/30 text-[#25D366] text-xs font-medium transition-colors"
            >
              <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
